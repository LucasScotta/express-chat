...
module.exports = (req, resp, next) => {
  ...
  const res = (req._parsedUrl.path === '/logout'
          && req._parsedUrl.path && '/login/create'
          && req._parsedUrl.path !== '/login')
  if(!res) {
    req.sesion.loginNext = process.env.API_ROUTE + req._parsedUrl.path
  }
